...
$DataSupervisores = $OverhaulingController->TraerSupervisores();
$Diagnosticos = $OverhaulingController->LeerDiagnosticos($ID_Centro);
$NoDiagnosticos = $OverhaulingController->ContarDiagnosticos($ID_Centro);

if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($_POST['Tipo'] == "MantenimietoPreventivo") {
        $TipoMontacargas = ucfirst(strtolower(trim($_POST['tipoMontacargas'])));
        ...
        $ClaseH = isset($_POST['ClaseH']) && trim($_POST['ClaseH']) !== '' ? $_POST['ClaseH'] : NULL;
        $LongitudH = isset($_POST['LongitudH']) && trim($_POST['LongitudH']) !== '' ? $_POST['LongitudH'] : NULL;
        $Voltaje = isset($_POST['Voltaje']) && trim($_POST['Voltaje']) !== '' ? $_POST['Voltaje'] : NULL;
        $Horometro = isset($_POST['Horometro']) && trim($_POST['Horometro']) !== '' ? $_POST['Horometro'] : NULL;
        $Marca = $_POST['nombreMarca'];
        $Serie = $_POST['numeroSerie'];
        $Modelo = $_POST['numeroModelo'];
        ...
        $Criterio_102 = isset($_POST['Criterio_102']) && trim($_POST['Criterio_102']) !== '' ? $_POST['Criterio_102'] : NULL;
        $Criterio_103 = isset($_POST['Criterio_103']) && trim($_POST['Criterio_103']) !== '' ? $_POST['Criterio_103'] : NULL;
        $Criterio_104 = isset($_POST['Criterio_104']) && trim($_POST['Criterio_104']) !== '' ? $_POST['Criterio_104'] : NULL;
        $Criterio_105 = isset($_POST['Criterio_105']) && trim($_POST['Criterio_105']) !== '' ? $_POST['Criterio_105'] : NULL;
        $Criterio_106 = isset($_POST['Criterio_106']) && trim($_POST['Criterio_106']) !== '' ? $_POST['Criterio_106'] : NULL;
        $Criterio_107 = isset($_POST['Criterio_107']) && trim($_POST['Criterio_107']) !== '' ? $_POST['Criterio_107'] : NULL;
        $Criterio_108 = isset($_POST['Criterio_108']) && trim($_POST['Criterio_108']) !== '' ? $_POST['Criterio_108'] : NULL;
        $Criterio_109 = isset($_POST['Criterio_109']) && trim($_POST['Criterio_109']) !== '' ? $_POST['Criterio_109'] : NULL;
        $Criterio_110 = isset($_POST['Criterio_110']) && trim($_POST['Criterio_110']) !== '' ? $_POST['Criterio_110'] : NULL;
        $Criterio_111 = isset($_POST['Criterio_111']) && trim($_POST['Criterio_111']) !== '' ? $_POST['Criterio_111'] : NULL;
        $Criterio_112 = isset($_POST['Criterio_112']) && trim($_POST['Criterio_112']) !== '' ? $_POST['Criterio_112'] : NULL;
        $Criterio_113 = isset($_POST['Criterio_113']) && trim($_POST['Criterio_113']) !== '' ? $_POST['Criterio_113'] : NULL;
        $Criterio_114 = isset($_POST['Criterio_114']) && trim($_POST['Criterio_114']) !== '' ? $_POST['Criterio_114'] : NULL;
        $Criterio_115 = isset($_POST['Criterio_115']) && trim($_POST['Criterio_115']) !== '' ? $_POST['Criterio_115'] : NULL;
        $Criterio_116 = isset($_POST['Criterio_116']) && trim($_POST['Criterio_116']) !== '' ? $_POST['Criterio_116'] : NULL;
        $Criterio_117 = isset($_POST['Criterio_117']) && trim($_POST['Criterio_117']) !== '' ? $_POST['Criterio_117'] : NULL;
        $Criterio_118 = isset($_POST['Criterio_118']) && trim($_POST['Criterio_118']) !== '' ? $_POST['Criterio_118'] : NULL;
        $Criterio_119 = isset($_POST['Criterio_119']) && trim($_POST['Criterio_119']) !== '' ? $_POST['Criterio_119'] : NULL;
        $Criterio_120 = isset($_POST['Criterio_120']) && trim($_POST['Criterio_120']) !== '' ? $_POST['Criterio_120'] : NULL;
        $Criterio_121 = isset($_POST['Criterio_121']) && trim($_POST['Criterio_121']) !== '' ? $_POST['Criterio_121'] : NULL;
        $Criterio_122 = isset($_POST['Criterio_122']) && trim($_POST['Criterio_122']) !== '' ? $_POST['Criterio_122'] : NULL;
        $Criterio_123 = isset($_POST['Criterio_123']) && trim($_POST['Criterio_123']) !== '' ? $_POST['Criterio_123'] : NULL;
        $Criterio_124 = isset($_POST['Criterio_124']) && trim($_POST['Criterio_124']) !== '' ? $_POST['Criterio_124'] : NULL;
        $Criterio_125 = isset($_POST['Criterio_125']) && trim($_POST['Criterio_125']) !== '' ? $_POST['Criterio_125'] : NULL;
        $Criterio_126 = isset($_POST['Criterio_126']) && trim($_POST['Criterio_126']) !== '' ? $_POST['Criterio_126'] : NULL;
        $Criterio_127 = isset($_POST['Criterio_127']) && trim($_POST['Criterio_127']) !== '' ? $_POST['Criterio_127'] : NULL;
        $Criterio_128 = isset($_POST['Criterio_128']) && trim($_POST['Criterio_128']) !== '' ? $_POST['Criterio_128'] : NULL;
        $Criterio_129 = isset($_POST['Criterio_129']) && trim($_POST['Criterio_129']) !== '' ? $_POST['Criterio_129'] : NULL;
        $Criterio_130 = isset($_POST['Criterio_130']) && trim($_POST['Criterio_130']) !== '' ? $_POST['Criterio_130'] : NULL;
        $Criterio_131 = isset($_POST['Criterio_131']) && trim($_POST['Criterio_131']) !== '' ? $_POST['Criterio_131'] : NULL;
        $Bateria = $_FILES['imagenesDiagnosticoBateria'] ?? null;
        $Electrico = $_FILES['imagenesDiagnosticoElectrico'] ?? null;
        $Traccion = $_FILES['imagenesDiagnosticoTraccion'] ?? null;
        $Frenos = $_FILES['imagenesDiagnosticoFrenos'] ?? null;
        $Direccion = $_FILES['imagenesDiagnosticoDireccion'] ?? null;
        $Hidraulico = $_FILES['imagenesDiagnosticoHidraulico'] ?? null;
        $Mastil = $_FILES['imagenesDiagnosticoMastil'] ?? null;
        $CarroPorta = $_FILES['imagenesDiagnosticoCarroPorta'] ?? null;
        $Lubricacion = $_FILES['imagenesDiagnosticoLubricacion'] ?? null;
        $Horquillas = $_FILES['imagenesDiagnosticoHorquillas'] ?? null;
        $Chasis = $_FILES['imagenesDiagnosticoChasis'] ?? null;
        $Ruedas = $_FILES['imagenesDiagnosticoRuedas'] ?? null;
        $Luces = $_FILES['imagenesDiagnosticoLuces'] ?? null;
        $Aditamientos = $_FILES['imagenesDiagnosticoAditamientos'] ?? null;
        $Cargador = $_FILES['imagenesDiagnosticoCargador'] ?? null;
        $Revision = $_FILES['imagenesDiagnosticoRevision'] ?? null;
        $Auxiliares = $_FILES['imagenesDiagnosticoAuxiliares'] ?? null;
        $Suspension = $_FILES['imagenesDiagnosticoSuspension'] ?? null;
        $Pantografo = $_FILES['imagenesDiagnosticoPantografo'] ?? null;
        $Motor = $_FILES['imagenesDiagnosticoMotor'] ?? null;
        $Refrigeracion = $_FILES['imagenesDiagnosticoRefrigeracion'] ?? null;
        $Combustion = $_FILES['imagenesDiagnosticoCombustion'] ?? null;
        $Transmision = $_FILES['imagenesDiagnosticoTransmision'] ?? null;
        $Caja = $_FILES['imagenesDiagnosticoCaja'] ?? null;
        $Componentes = $_FILES['imagenesDiagnosticoComponentes'] ?? null;
        $Ausencia = $_FILES['imagenesDiagnosticoAusencia'] ?? null;
        $Revisiones = $_FILES['imagenesDiagnosticoRevisiones'] ?? null;
        $Funcionamiento = $_FILES['imagenesDiagnosticoFuncionamiento'] ?? null;
        $Correas = $_FILES['imagenesDiagnosticoCorreas'] ?? null;
        $Unidad = $_FILES['imagenesDiagnosticoUnidad'] ?? null;
        $Panel = $_FILES['imagenesDiagnosticoPanel'] ?? null;
        $Pintura = $_FILES['imagenesDiagnosticoPintura'] ?? null;
        $trabajos = json_decode($_POST['TrabajosRealizados'], true);
        $ID_Usuario = $_SESSION['ID'];
        $NombreCreo = $_SESSION['Nombre1'];

        if($ID_Diagnostico =$OverhaulingController->RegistrarDiagnosticoInicial($ID_Usuario, $ID_Centro, $TipoMontacargas, $ID_Supervisor, $Correo_Supervisor, $Nombre_Supervisor, $Tecnicos, $ClaseH, $LongitudH, $Voltaje, $Horometro, $Serie, $Modelo, $Marca,
            ...
            <script>
                Swal.fire({
                    title: 'Diagnostico Inicial Creado!',
                    text: 'El overhauling inicial se ha creado exitosamente.',
                    icon: 'success',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = 'FirmaDiagnostico?ID=' + " . $ID_Diagnostico . ";
                    }
                });
            </script>";
        } else {
            ...
            <script>
                Swal.fire({
                    title: 'Error!',
                    text: 'El overhauling inicial no se pudo crear, por favor intente de nuevo.',
                    icon: 'error',
                    timer: 3000,
        ...
        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-2 mb-4">
            <form method="get" action="" class="mb-0">
                <div class="d-flex align-items-center flex-wrap gap-2">
                    <h6 class="mb-0">Diagnosticos Realizados |</h6>
                    <select name="centro" 
        ...
        <div class="table-responsive">
            <table class="table text-start align-middle table-bordered table-hover mb-0" id="myTable">
                ...
                <tbody>
                    ...
                    ?>
                            <tr data-id="<?= htmlspecialchars($Diagnostico['ID']) ?>">
                                <td width="100" class="text-center"><?= htmlspecialchars($Diagnostico['Numero']) ?></td>
                                <td><?= htmlspecialchars($Diagnostico['Fecha_Realizado']) ?></td>
                                 <td><?= htmlspecialchars($Diagnostico['Marca']) ?></td>
                                <td><?= htmlspecialchars($Diagnostico['Serie']) ?></td>
                                <td><?= htmlspecialchars($Diagnostico['Modelo']) ?></td>
                                <!-- <td><?= htmlspecialchars($Diagnostico['NombreUsuario']) ?></td> -->
                                <!-- <td>
                                    <div class="progress">
                                ...
                                <td width="200" class="text-center">
                                    <a class="btn btn-sm btn-primary" target="_blank" href="VerDiagnostico<?= urlencode(htmlspecialchars($Diagnostico['Tipo_Montacargas'])) ?>?ID=<?= urlencode(htmlspecialchars($Diagnostico['ID'])) ?>">
                                        <img width="20" height="20" src="https://img.icons8.com/material-outlined/24/ffffff/visible--v1.png" alt="Ver" />
                                    </a>
                                    <a class="btn btn-sm btn-success" target="_blank" title="Resultados de Diagnostico" href="VerTrabajos?ID=<?= urlencode(htmlspecialchars($Diagnostico['ID'])) ?>">
                                        <img width="20" height="20" src="https://img.icons8.com/ios-filled/50/ffffff/survey.png" alt="Lista de trabajos" />
                                    </a>

                                    <?php if ( $_SESSION['ID'] == $Diagnostico['ID_Supervisor'] && $Diagnostico['Estado_Firma_Supervisor'] != 1) { ?>
                                        <a class="btn btn-sm btn-dark" target="_blank" href="FirmaSupervisor?ID=<?= urlencode(htmlspecialchars($Diagnostico['ID'])) ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary">                
                <h5 class="modal-title text-white" id="NumerDocumentoModalLabel">Diagnostico Inicial</h5>
            ...
            <div class="modal-body">
                <form id="documentFormIngreso" method="POST">
                    <div class="mb-3">
                        ...
                        <label for="MarcaM" class="form-label">Marca</label>
                        <input type="text" class="form-control" id="MarcaM" name="MarcaM" placeholder="Ingrese marca" required>
                        <label for="SerieM" class="form-label">Número de serie</label>
                        <input type="text" class="form-control" id="SerieM" name="SerieM" placeholder="Ingrese número de serie" required>
                        <label for="ModeloM" class="form-label">Modelo</label>
                        <input type="text" class="form-control" id="ModeloM" name="ModeloM" placeholder="Ingrese modelo" required>
                        ...
                        <div class="col-md-4">
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="nombreMarca" id="nombreMarca" readonly>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="Voltaje" id="Voltaje">
                                    </div>
                                    <div class="col-md-6">
    ...
    function cargarCriteriosHorquillas(tipo) {
        ...
        criterios.forEach((item) => {
            ...
            // CASO ESPECIAL: LONGITUD DE HORQUILLAS
                ...
                <div class="mb-3">
                    <label class="form-label">${item.label}</label>
                    <input type="text" class="form-control" id="inputLongitudH"
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (Ingreso) {
            Ingreso.addEventListener("submit", function (e) {
                ...
                const MarcaM = document.getElementById("MarcaM");
                const SerieM = document.getElementById("SerieM");
                const ModeloM = document.getElementById("ModeloM");
                ...
                const MarcaMTexto = MarcaM?.value || "";
                const SerieMTexto = SerieM?.value || "";
                const ModeloMTexto = ModeloM?.value || "";
                ...
                Swal.fire({
                    title: 'Diagnostico Inicial Creado!',
                    text: `Diagnostico para montacargas con serie "${SerieMTexto}"  creado exitosamente.`,
                    icon: 'success',
                    showCancelButton: true,
                    confirmButtonText: 'Continuar',
                    cancelButtonText: 'Cancelar',
                    ...
                    if (result.isConfirmed) {
                        ...
                        setVal("numeroSerie", SerieMTexto);
                        setVal("numeroModelo", ModeloMTexto);
                        setVal("nombreMarca", MarcaMTexto);
                        ...
                        if (tituloModal) {
                            ...
                            switch (tipoMontacargas?.value) {
                                case "combustion":
                                    nuevoTitulo = "Diagnóstico Inicial Combustión";
                                    break;
                                case "pasillo":
                                    nuevoTitulo = "Diagnóstico Inicial Eléctrico Pasillo Angosto";
                                    break;
                                case "contrabalanceada":
                                    nuevoTitulo = "Diagnóstico Inicial Eléctrico Contrabalanceada";
                                    break;
                                case "manlift":
                                    nuevoTitulo = "Diagnóstico Inicial Manlift";
                                    break;
                                default:
                                    nuevoTitulo = "Diagnóstico Inicial";
                            }
