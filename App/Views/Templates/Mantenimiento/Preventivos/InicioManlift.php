...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($_POST['Tipo'] == "MantenimietoPreventivo") {
        ...
        $Revisiones = $_FILES['imagenesDiagnosticoChasis'];
        ...
        $Motor = NULL;
        $Refigeracion = NULL;
        $Componentes = $_FILES['imagenesDiagnosticoRevision'];
        $Ausencias = $_FILES['imagenesDiagnosticoAditamientos'];
        $Correas = $_FILES['imagenesDiagnosticoCaja'];
        $Panel = $_FILES['imagenesDiagnosticoHorquillas'];
        $Funcionamiento = $_FILES['imagenesDiagnosticoLuces'];
                    ...
                    ?>
                            <tr data-id="<?= htmlspecialchars($Mantenimiento['ID']) ?>">
                                ...
                                <td width="200" class="text-center">
                                    <a class="btn btn-sm btn-primary" target="_blank" href="VerMantenimientoManlift?ID=<?= urlencode(htmlspecialchars($Mantenimiento['ID'])) ?>">
...
<div class="modal fade" id="agregarMantenimiento" tabindex="-1" aria-labelledby="agregarMantenimientoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="agregarMantenimientoModalLabel">Mantenimiento Preventivo Manlift</h5>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="Criterio_4" class="form-label">Compartimiento bateria</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_5" class="form-label">Estado de los puentes</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_6" class="form-label">Estado de la batería</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalElectrico" tabindex="-1" aria-labelledby="ModalElectricoLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_13" class="form-label">Fusibles</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_14" class="form-label">Conexiones</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_15" class="form-label">Sistema de seguridad cables potencia</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_16" class="form-label">Conectores</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_17" class="form-label">Soportes</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_18" class="form-label">Cauchos</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_19" class="form-label">Controlador</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_20" class="form-label">Contactores</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_21" class="form-label">Displey</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_22" class="form-label">Contactor de linea</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_23" class="form-label">Contactor de dirección</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_24" class="form-label">Contactor de elevacion</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_25" class="form-label">Contactores de marcha</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalTraccion" tabindex="-1" aria-labelledby="ModalTraccionLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #000020;">
                <h5 class="modal-title text-white" id="ModalTraccionLabel">Diagnóstico: Unidad De Tracción</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_89" class="form-label">Nivel de aceite</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_90" class="form-label">Fugas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_91" class="form-label">Conexiones de cables</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_92" class="form-label">Motor tracción</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalFrenos" tabindex="-1" aria-labelledby="ModalFrenosLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #000020;">
                <h5 class="modal-title text-white" id="ModalFrenosLabel">Diagnóstico: Frenos</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_75" class="form-label">Efciencia del mecanismo</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_76" class="form-label">Estado degaste del disco</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_77" class="form-label">Nivel del aceite hidráulico de los frenos</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_78" class="form-label">Pedal de frenos</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_79" class="form-label">Bomba de frenado</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_80" class="form-label">Desgastes de pastillas de freno</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalDireccion" tabindex="-1" aria-labelledby="ModalDireccionLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_53" class="form-label">Generador de torque</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_54" class="form-label">Escobillas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_55" class="form-label">Fugas por cilindro de dirección</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_56" class="form-label">Niveles de aceite y grasa</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_57" class="form-label">Mangueras de dirección</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_58" class="form-label">Columna de dirección</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_59" class="form-label">Motor de dirección</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_60" class="form-label">Conexiones hidráulicas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_61" class="form-label">Funcionamiento del sistema de dirección</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalHidraulico" tabindex="-1" aria-labelledby="ModalHidraulicoLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_26" class="form-label">Estado y nivel de aceite</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_27" class="form-label">Fugas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_28" class="form-label">Filtros</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_29" class="form-label">Funcionamiento de válvulas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_30" class="form-label">Racores</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_31" class="form-label">Cilindros hidráulicos</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_32" class="form-label">Bomba hidráulica</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_33" class="form-label">Estado de electroválvulas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_34" class="form-label">Abolladuras vástago y carcasa</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_35" class="form-label">Ojos o juntas conexión sueltas o fisuradas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_36" class="form-label">Estado de las mangueras</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_37" class="form-label">Estado de las conexiones</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_38" class="form-label">Accionamiento normal sin bloqueos</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalAditamientos" tabindex="-1" aria-labelledby="ModalAditamientosLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #000020;">
                <h5 class="modal-title text-white" id="ModalAditamientosLabel">Diagnóstico: Ausencia De Piezas O Componentes</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_43" class="form-label">Pasadores</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_44" class="form-label">Cojinetes</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_45" class="form-label">Ejes</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_46" class="form-label">Corona de giro</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_47" class="form-label">Motor de giro</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_48" class="form-label">Rodillos</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_49" class="form-label">Puntos de anclaje</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_50" class="form-label">Pernos</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_51" class="form-label">Tuercas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_52" class="form-label">Remaches</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalHorquillas" tabindex="-1" aria-labelledby="ModalHorquillasLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #000020;">
                <h5 class="modal-title text-white" id="ModalHorquillasLabel">Diagnóstico: Panel De Controles</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_93" class="form-label">Controladores en marcha</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_94" class="form-label">Switches de marcha</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_95" class="form-label">Contractores hidráulicos</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_96" class="form-label">Switches hidráulicos</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_97" class="form-label">Mandos en el tablero de la canastila</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_98" class="form-label">Sensor de persona en canastila</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalRuedas" tabindex="-1" aria-labelledby="ModalRuedasLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_86" class="form-label">Estado de los rines</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_87" class="form-label">Estado de ruedas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_88" class="form-label">Presión de neumáticos</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalCaja" tabindex="-1" aria-labelledby="ModalCajaLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #000020;">
                <h5 class="modal-title text-white" id="ModalCajaLabel">Diagnóstico: Correas Y Cadenas</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_81" class="form-label">Chequear ajustes</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_82" class="form-label">Ausencia de corrosión</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_83" class="form-label">Ausencia de cortes</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_84" class="form-label">Ausencia de deformaciones en eslabones</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_85" class="form-label">Ausencia de pasadores desencajados</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalChasis" tabindex="-1" aria-labelledby="ModalChasisLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #000020;">
                <h5 class="modal-title text-white" id="ModalChasisLabel">Diagnóstico: Revisiones De Operación</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_64" class="form-label">Medidor horas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_65" class="form-label">Extintores</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_66" class="form-label">Bocina</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_67" class="form-label">Luces indicadoras</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_68" class="form-label">Desconector de emergencia</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_69" class="form-label">Operación de controles</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_70" class="form-label">Frenado</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_71" class="form-label">Control manual en tierra</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_72" class="form-label">Control manual en canastilla</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_73" class="form-label">Señalización de mandos de tierra</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_74" class="form-label">Señalización de mandos en plataforma</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalLuces" tabindex="-1" aria-labelledby="ModalLucesLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #000020;">
                <h5 class="modal-title text-white" id="ModalLucesLabel">Diagnóstico: Funcionamiento General</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_99" class="form-label">Funcionamiento</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalLubricacion" tabindex="-1" aria-labelledby="ModalLubricacionLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_62" class="form-label">Engrasar - lubricar</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_63" class="form-label">Engranajes - cadenas - piñones</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalCargador" tabindex="-1" aria-labelledby="ModalCargadorLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #000020;">
                <h5 class="modal-title text-white" id="ModalAditamientosLabel">Diagnóstico: Cargador</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="Criterio_7" class="form-label">Estado</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_8" class="form-label">Voltaje promedio</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_9" class="form-label">Cables de potencia</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_10" class="form-label">Conector anderson</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_11" class="form-label">Amperaje</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_12" class="form-label">Fusibles</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalRevision" tabindex="-1" aria-labelledby="ModalRevisionLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #000020;">
                <h5 class="modal-title text-white" id="ModalRevisionLabel">Diagnóstico: Componentes Estructurales</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_39" class="form-label">Estado del chasis - bastidor</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_40" class="form-label">Estructura extensible</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_41" class="form-label">Estado de la plataforma</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_42" class="form-label">Estado del punto de anclaje</label>
                    <div class="d-flex align-items-center">
