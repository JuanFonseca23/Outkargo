    ...
    <table border="1">
        <thead>
            <tr>
                ...
                <th rowspan="3" class="Titulo" style="font-size: 14px;" >REPORTE DE MANTENIMIENTO PREVENTIVO ELECTRICA CONTRABALANCEADA 250 HORAS</th>
                <th>CODIGO:</th>
                <td>F-211-1-1</td>
            </tr>
            <tr>
    ...
    <table border="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Mictros de funciones hidráulicas</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Contactor de elevación</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Contactor de marcha</td>
