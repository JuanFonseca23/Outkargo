    ...
    <table border="1">
        <thead>
            <tr>
                ...
                <th rowspan="3" class="Titulo" style="font-size: 14px;" >REPORTE DE MANTENIMIENTO PREVENTIVO ELECTRICA CONTRABALANCEADA 1000 HORAS</th>
                <th>CODIGO:</th>
                <td>F-211-1-2</td>
            </tr>
            <tr>
    ...
    <table border="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Estado y nivel aceite hidráulico</td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Motor de sistema hidráulico</td>
                <td style="text-align:center;"><?= $DataDetalleM['Criterio_50'] ?></td>
                <td colspan="2" style="font-weight: bold;">Forkpositioner</td>
