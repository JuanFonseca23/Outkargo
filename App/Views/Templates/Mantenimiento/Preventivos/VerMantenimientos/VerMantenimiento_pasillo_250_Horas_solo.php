    ...
    <table border="1">
        <thead>
            <tr>
                ...
                <th rowspan="3" class="Titulo" style="font-size: 14px;" >REPORTE DE MANTENIMIENTO PREVENTIVO ELECTRICA PASILLO ANGOSTO 250 HORAS</th>
                <th>CODIGO:</th>
                <td>F-211-3-1</td>
            </tr>
            <tr>
    ...
    <table border="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Nivel de aceite hidraulico</td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Alarma de reversa</td>
            ...
            <tr>
                ...
                <td colspan="3" style="background-color: #e6e6e6; font-weight: bold; text-align:center;">PANTÓGRAFO</td>
