    ...
    <table border="1">
        <thead>
            <tr>
                ...
                <th rowspan="3" class="Titulo" style="font-size: 14px;" >REPORTE DE MANTENIMIENTO PREVENTIVO ELECTRICA CONTRABALANCEADA 2000 HORAS</th>
                <th>CODIGO:</th>
                <td>F-211-1-3</td>
            </tr>
            <tr>
    ...
    <table border="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Cambio de aceite hidráulico</td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Mantenimiento de motor de sistema hidráulico</td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Caucho adsorbedor de golpe</td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Bomba sistema hidráulico</td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Cambio de filtro de retorno</td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Luz de freno</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Mantenimiento contactor linea</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Mantenimiento contactor direccion</td>
                <td style="text-align:center;"><?= $DataDetalleM['Criterio_17'] ?></td>
                <td colspan="2" style="font-weight: bold;">Mangueras sideshift</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Mantenimiento contactor de elevación</td>
                <td style="text-align:center;"><?= $DataDetalleM['Criterio_18'] ?></td>
                <td colspan="2" style="font-weight: bold;">Mangueras forkpositioner</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Mantenimiento contactor de marcha</td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Cilindro de freelift</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Mantenimiento de motor de tracción</td>
                <td style="text-align:center;"><?= $DataDetalleM['Criterio_23'] ?></td>
                <td colspan="2" style="font-weight: bold;">Cilindros de sideshift</td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Cilindros de forkpositioner</td>
                <td style="text-align:center;"><?= $DataDetalleM['Criterio_75'] ?></td>
                <td colspan="2" style="font-weight: bold;">Manual de opeaciones</td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Desgaste de caucho de ruedas de carga</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Cambio de valvulina</td>
                <td style="text-align:center;"><?= $DataDetalleM['Criterio_27'] ?></td>
                <td colspan="2" style="font-weight: bold;">Desgaste de caucho de ruedas de dirección</td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Estado de rin de direccion</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Cambio de liquido de frenos</td>
                <td style="text-align:center;"><?= $DataDetalleM['Criterio_29'] ?></td>
                <td colspan="2" style="font-weight: bold;">Limpieza</td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Pintura en mástil y secciones moviles</td>
            ...
            <tr>
                <td colspan="3" style="background-color: #e6e6e6; font-weight: bold; text-align:center;">SISTEMA DE DIRECCIÓN</td>
                <td colspan="3" style="background-color: #e6e6e6; font-weight: bold; text-align:center;">HORQUILLAS</td>
                <td colspan="2"></td>
                <td ></td>
            </tr>
            <tr>
                <td colspan="2" style="font-weight: bold;">Mantenimiento de motor de dirección</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Bomba de dirección</td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Estado de horquillas (inspeccion visual ver F-208)</td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Sideshift</td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Forkpostioner</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Terminal de dirección</td>
