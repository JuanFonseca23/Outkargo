        ...
        <thead>
            <tr>
                ...
                <th rowspan="3" class="Titulo" style="font-size: 14px;">
                    REPORTE DE MANTENIMIENTO PREVENTIVO COMBUSTIÓN 2000 HORAS
                </th>
                <th >CODIGO:</th>
                <td style="width: 70px; text-align: center;">F-211-2-3</td>
            </tr>
            <tr>
                <th>FECHA:</th>
    ...
    <table border="1">
        <thead>
            <tr>
                ...
                <th>Fecha:</th>
                <td>
                    <?= date('d/m/Y', strtotime($DataMantenimiento['Fecha_Realizado'])) ?>
                </td>
            </tr>  
            <tr>
                <th>Montacargas N°:</th>
    ...
    <table border="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Cambio de líquido de frenos</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Mantenimiento alternador</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Mantenimiento motor de arranque</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Cambio de aceite hidraulico</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Cambio de cables de alta</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Cambio de tapa de distribuidor</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Cambio de rotor o escobilla</td>
                ...
                <td style="text-align:center;"><?= $DataDetalleM['Criterio_109'] ?></td>
                 <td colspan="2" style="font-weight: bold;">Cambio de aceite</td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Cambio filtro</td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Mantenimiento cardán</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Mantenimiento radiador</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Cambio de correa de accesorios</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Cambio de líquido refrigerante</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Mantenimiento del carburador</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Mantenimiento del regulador de gas</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Cambio de filtro del regulador de gas</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Cambio de estado de bujias</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Cambio de filtro de combustible</td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Capo y amortiguador</td>
