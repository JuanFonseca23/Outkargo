...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($_POST['Tipo'] == "MantenimietoPreventivo") {
        ...
        if ($FallaC === 'si') {
            ...
            $FechaCorrecion = date("d/m/Y", strtotime($FechaCorrecion));
        ...
        if($ID_Mantenimiento = $MantenimientosController->RegistrarMantenimientoCorrectivo($ID_Usuario, $NombreCreo, $ID_Montacargas,$ID_Area,$ID_Operario,$ID_Centro,$ID_Supervisor,$Correo_Supervisor,$Nombre_Supervisor,$Horometro, $HoraInicio,
            ...
            <script>
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = 'FirmaMantenimientoC?ID=' + " . $ID_Mantenimiento . ";
                    }
                });
            </script>";
        } else {
                ...
                <form id="documentFormMantenimiento" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-8"> 
                            ...
                            <label for="Insumos">Insumos y repuestos instalados:</label>
                            <textarea class="form-control" id="Insumos" name="Insumos" rows="5" placeholder="Insumos y repuestos intalados" required></textarea>
                            <br>
                            <div class="row mb-3">
                                <div class="col-md-6">
