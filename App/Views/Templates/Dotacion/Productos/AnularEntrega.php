<?php
    ...
    $DataEntrada = $DotacionController->VerEntrega($_GET['ID'], $_SESSION['NoCentro']);

    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        $Descripcion = $_POST['Comentario'];
        $NoFormulario = $_POST['NoFormulario'];      
        $DotacionController->AnularDotacionEntrega($_GET['ID'], $_SESSION['ID'], $_SESSION['Nombre1'], $Descripcion, $NoFormulario);
    }
?>
        ...
        <div class="col-sm-12 col-xl-12">
            <div class="bg-light rounded h-100 p-4">
                <form method="post" enctype="multipart/form-data">
                    <h6 class="mb-4">Anular Entrega</h6>
                    <div class="form-floating mb-3">
                        <input name="NoFormulario" class="form-control" id="floatingInput" value=<?= $DataEntrada['ID'] ?> required readonly>
