...
$ID_Crea = $_SESSION['ID'];
$Listas = $ProductosController->LeerInventarioTotal();
                ...
                <tbody>
                    ...
                    ?>
                            <tr data-id="<?= htmlspecialchars($Lista['ID']) ?>">
                                ...
                                <td><?= htmlspecialchars($Lista['N_Factura']) ?></td>
                                <td style="text-align: center;">$<?=htmlspecialchars(number_format($Lista['valor_unitario'], 0, ',', '.')) ?></td>
                                <td><?= htmlspecialchars($Lista['Centro']) ?></td>
