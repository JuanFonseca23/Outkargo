...
$Listas = $ProductosController->LeerTraslados($ID_Centro);
$Nombre = $ProductosController->Centro($ID_Centro);
$NoEntradas = $ProductosController->ContarTraslados($ID_Centro);
...
<div class="container-fluid pt-4 px-4">
    <div class="bg-light text-center rounded p-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <?php
                if (!empty($Centro)) {
                    echo '<h6 class="mb-0">Traslados Realizados | ' . htmlspecialchars($Centro) . '</h6>';
                } else {
                    echo '<h6 class="mb-0">Traslados Realizados | No disponible</h6>';
                }
            ?>
            <div>
                <a href="InicioTrasladosSedes">Ver Todas</a>
                <a>|</a>
