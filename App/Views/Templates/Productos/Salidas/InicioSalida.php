...
$Listas = $ProductosController->LeerSalidas($ID_Centro);
$Nombre = $ProductosController->Centro($ID_Centro);
$NoSalidas = $ProductosController->ContarSalidas($ID_Centro);
...
<div class="container-fluid pt-4 px-4">
    <div class="bg-light text-center rounded p-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <?php
                if (!empty($Centro)) {
                    echo '<h6 class="mb-0">Salidas Realizadas | ' . htmlspecialchars($Centro) . '</h6>';
                } else {
                    echo '<h6 class="mb-0">Salidas Realizadas | No disponible</h6>';
                }
            ?>
            <div>
                <a href="InicioSalidaSedes">Ver Todas</a>
                <a> | </a>
            ...
            <table class="table text-start align-middle table-bordered table-hover mb-0" id="myTable">
                <thead>
                    <tr class="text-dark">
                        ...
                        <th scope="col" class="text-center">Nombre Recibe</th>
                        <th scope="col" class="text-center">Nombre Supervisor</th>
