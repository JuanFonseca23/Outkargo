<?php
    ...
    $estadoFirma = $ProductosController->verificarEstadoFirmaSalida($ID_Salida); 
...
<body>
    <?php
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {  
                ...
                $ProductosController->FirmarSalidaSupervisor($ID, $Usuario, $Nombre_Ingresa, $No_Formulario, $Firma_Supervisor);                                                   
            }
    ?>
    <style>
        #signature-pad {
