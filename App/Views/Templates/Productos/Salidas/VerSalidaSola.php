...
$DataEntrada = $ProductosController->VerSalida($_GET['ID']);
        ...
        <tbody>
            <tr height="100px">
                ...
                <td width="50%" style="text-align: center;">
                    <img src="<?= $DataEntrada['Firma_Salida'] ?>" style="max-width: 100%;">
                </td>
                <td width="50%" style="text-align: center;">
            ...
            <tr>
                <th style="text-align: center;"><?= $DataEntrada['NombreSalida'] ?></th>
