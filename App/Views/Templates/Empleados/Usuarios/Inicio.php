<?php 
    ...
    $Listas = $Empleados->Leer();
    $NoUsuario = $Empleados->ContarUsuariosActivos();
?>
<!-- Sale & Revenue Start -->
<div class="container-fluid pt-4 px-4">
    <div class="row g-4">
        ...
        <a class="col-sm-6 col-xl-3" href="../Empleados/Eliminados">
            <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
            <img width="50" height="50" src="https://img.icons8.com/ios/50/000020/lock--v1.png" alt="lock--v1"/>
                <div class="ms-3">
                    <p class="mb-2" style="color: #000020;">Ex trabajadores</p>
                </div>
            </div>
        </a>
        <a class="col-sm-6 col-xl-3" href="../Empleados/Informe">
            <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                ...
                <tbody>
                    ...
                    ?>
                        <tr data-id="<?= htmlspecialchars($Lista['ID']) ?>">
                            ...
                            <td><a class="btn btn-sm btn-danger" onclick="confirmarDesactivacion(<?= htmlspecialchars($Lista['ID']) ?>)">Eliminar</a></td>
                        </tr>
                    <?php
                            }
                        }                                    
