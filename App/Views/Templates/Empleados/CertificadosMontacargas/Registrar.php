            ...
            <div class="bg-light rounded h-100 p-4">
                <?php
                    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                        ...
                        $CertificadosMontacargasController->IngresarCertificados($_SESSION['ID'], $_SESSION['Nombre1'], $ID, $Nombre, $Fecha_Realizado, $Fecha_Vencimiento,  $Documento, $NombreUsuario, $DocumentoUsuario);
                    }
                ?>
                <form method="post" enctype="multipart/form-data">
                    <h6 class="mb-4">Ingresar Certificado</h6>
