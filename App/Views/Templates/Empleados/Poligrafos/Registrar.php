            ...
            <div class="bg-light rounded h-100 p-4">
                <?php
                    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                        ...
                        $PoligrafosController->IngresarPoligrafos($_SESSION['ID'], $_SESSION['Nombre1'], $ID, $Nombre, $Fecha_Realizado, $Documento, $NombreUsuario, $DocumentoUsuario);
                    }
                ?>
                <form method="post" enctype="multipart/form-data">
                    <h6 class="mb-4">Ingresar Nuevo Polígrafo</h6>
