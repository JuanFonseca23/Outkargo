<?php
    ...
    if ($TipoSolicitud === 'Overhauling') {
        $OverhaulingNumero = $_GET['OverhaulingNumero'] ?? '';
        $Descripcion = "Solicitud de compra de repuestos y insumos para el overhauling número: {$OverhaulingNumero}";
    } else {
        $Descripcion = "Solicitud de compra de repuestos y insumos para mantenimiento preventivo o correctivo";
    }
