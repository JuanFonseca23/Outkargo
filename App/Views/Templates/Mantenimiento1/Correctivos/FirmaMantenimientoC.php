...
ini_set('display_errors', 1);
    ...
    $Tecnicos = $MantenimientoController->ObtenerTecnicosMantenimientoC($_GET['ID']);
?>
    ...
    <?php
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            if (isset($_POST['Tipo']) && $_POST['Tipo'] == "1") {
                ...
                $ID_Salida = isset($_GET['ID_Salida']) ? htmlspecialchars($_GET['ID_Salida']) : '';
                $Firmas = isset($_POST['firmasMecanicos']) ? $_POST['firmasMecanicos'] : [];
                $MantenimientoController->FirmarMantenimientoCorrectivo($ID_Mantenimiento, $ID_Salida, $Firmas);
            }
        }        
    ?>   
