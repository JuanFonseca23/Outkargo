...
$Criterios = [
    ...
    "Electrico" => [
        ...
        "contrabalanceada" => [
            ...
            ["label"=> "No. de controlador",                    "name"=> "contra_N_Controlador", "id"=>"contra_N_Controlador", "hidden"=> "N_Controlador"],
    ...
    "Cargador"=>[
        //PASILLO
        "pasillo" => [
            ["label"=> "No. Cargador",            "name"=> "pasillo_Cargador", "id"=>"pasillo_Cargador", "hidden"=> "N_Cargador"],
        ...
        // CONTRABALANCEADA
        "contrabalanceada" => [
            ["label"=> "No. Cargador",             "name"=> "contra_N_Cargador", "id"=>"contra_N_Cargador", "hidden"=> "N_Cargador"],
        ...
        "manlift" => [
            ...
            ["label"=> "No. Cargador",           "name"=> "manlift_N_Cargador", "id"=>"manlift_N_Cargador", "hidden"=> "N_Cargador"],
