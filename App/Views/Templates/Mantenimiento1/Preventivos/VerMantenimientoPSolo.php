    ...
    <table border="1">
        <thead>
            <tr>
                ...
                <th rowspan="3" class="Titulo" style="font-size: 14px;" >REPORTE DE MANTENIMIENTO PREVENTIVO ELECTRICA CONTRABALANCEADA</th>
                <th>CODIGO:</th>
                <td>F-211-1</td>
            </tr>
            <tr>
    ...
    <table border="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold;">Estado pintura</td>
