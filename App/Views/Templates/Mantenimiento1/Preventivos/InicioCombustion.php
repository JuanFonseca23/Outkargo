...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($_POST['Tipo'] == "MantenimietoPreventivo") {
        ...
        $Luces = NULL;
        $Caja = $_FILES['imagenesDiagnosticoCaja'];
        ...
        $Pantografo = NULL;
        $Suspension = NULL;
        $Combustion = $_FILES['imagenesDiagnosticoTraccion'];
        $Transmision = $_FILES['imagenesDiagnosticoCarroPorta'];
        $Motor = $_FILES['imagenesDiagnosticoLuces'];
        $Refigeracion = $_FILES['imagenesDiagnosticoCargador'];
        $Componentes = NULL;
        $Ausencias = NULL;
        $Correas =NULL;
        $Panel = NULL;
                    ...
                    ?>
                            <tr data-id="<?= htmlspecialchars($Mantenimiento['ID']) ?>">
                                ...
                                <td width="200" class="text-center">
                                    <a class="btn btn-sm btn-primary" target="_blank" href="VerMantenimientoCombustion?ID=<?= urlencode(htmlspecialchars($Mantenimiento['ID'])) ?>">
...
<div class="modal fade" id="agregarMantenimiento" tabindex="-1" aria-labelledby="agregarMantenimientoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="agregarMantenimientoModalLabel">Mantenimiento Preventivo Combustión</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">                            
                            ...
                            <div class="row">
                                ...
                                <a id="btnCajaCard" class="col-sm-6 col-xl-4" href="#" data-open-modal="#ModalCaja">
                                    <div class="bg-light rounded d-flex align-items-center justify-content-between p-3">
                            ...
                            <div class="row">
                                <a id="btnCarroPortaCard" class="col-sm-6 col-xl-4" href="#" data-open-modal="#ModalCarroPorta">
                                    <div class="bg-light rounded d-flex align-items-center justify-content-between p-3">
                                    <img width="48" height="48" src="https://img.icons8.com/pulsar-line/50/000020/engine-coolant.png" alt="engine-coolant"/>    
                                        <div class="ms-3">
                                ...
                                <a id="btnDireccionCard" class="col-sm-6 col-xl-4" href="#" data-open-modal="#ModalDireccion">
                                    <div class="bg-light rounded d-flex align-items-center justify-content-between p-3">
                                        ...
                                        <div class="ms-3">
                                            <p class="mb-2" style="color: #000020;">Dirección</p>
                                        </div>
                                    </div>
                                </a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="Criterio_1" class="form-label">Estado de bornes</label>
                ...
                <div class="mb-3">
                    <label for="Criterio_2" class="form-label">Cables de potencia</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalElectrico" tabindex="-1" aria-labelledby="ModalElectricoLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_3" class="form-label">Caja de fusibles</label>
                    <div class="d-flex align-items-center">
                        <select class="form-select" id="Criterio_3" name="Criterio_3" required>
                            <option value="" disabled selected>Seleccione</option>
                            <option value="Conforme">Conforme</option>
                            <option value="Nivelacion">Nivelación</option>
                            <option value="Ajuste">Ajuste</option>
                ...
                <div class="mb-3">
                    <label for="Criterio_4" class="form-label">Conexiones</label>
                    <div class="d-flex align-items-center">
                        <select class="form-select" id="Criterio_4" name="Criterio_4" required>
                            <option value="" disabled selected>Seleccione</option>
                            <option value="Conforme">Conforme</option>
                            <option value="Nivelacion">Nivelación</option>
                            <option value="Ajuste">Ajuste</option>
                ...
                <div class="mb-3">
                    <label for="Criterio_5" class="form-label">Conectores</label>
                    <div class="d-flex align-items-center">
                        <select class="form-select" id="Criterio_5" name="Criterio_5" required>
                            <option value="" disabled selected>Seleccione</option>
                            <option value="Conforme">Conforme</option>
                            <option value="Nivelacion">Nivelación</option>
                            <option value="Ajuste">Ajuste</option>
                ...
                <div class="mb-3">
                    <label for="Criterio_6" class="form-label">Modulo de control eléctrico (ECU)</label>
                    <div class="d-flex align-items-center">
                        <select class="form-select" id="Criterio_6" name="Criterio_6" required>
                            <option value="" disabled selected>Seleccione</option>
                            <option value="Conforme">Conforme</option>
                            <option value="Nivelacion">Nivelación</option>
                            <option value="Ajuste">Ajuste</option>
                ...
                <div class="mb-3">
                    <label for="Criterio_7" class="form-label">Display</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_8" class="form-label">Alternador</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_9" class="form-label">Motor de arranque</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalTraccion" tabindex="-1" aria-labelledby="ModalTraccionLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #000020;">
                <h5 class="modal-title text-white" id="ModalTraccionLabel">Diagnóstico: Sistema De Combustion</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_30" class="form-label">Estado del Carburador</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_31" class="form-label">Regulador de gas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_32" class="form-label">Filtro de aire</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_33" class="form-label">Filtro del regulador de gas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_34" class="form-label">Estado de bujías</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_35" class="form-label">Funcionamiento de la bomba de gasolina</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalFrenos" tabindex="-1" aria-labelledby="ModalFrenosLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_78" class="form-label">Liquido de frenos</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_79" class="form-label">Bomba de freno principal</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_80" class="form-label">Estado de bandas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_82" class="form-label">Freno de estacionamiento</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_83" class="form-label">Eficiencia de frenado</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_84" class="form-label">Guayas de parqueo</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_85" class="form-label">Pedal de freno</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalDireccion" tabindex="-1" aria-labelledby="ModalDireccionLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #000020;">
                <h5 class="modal-title text-white" id="ModalDireccionLabel">Diagnóstico: Dirección</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_86" class="form-label">Mangueras</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_87" class="form-label">Cilindro de dirección</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_88" class="form-label">Cauchos puente trasero</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_89" class="form-label">Rotulas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_90" class="form-label">Guarda polvo</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_91" class="form-label">Rodamientos</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_92" class="form-label">Orbitrol</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_93" class="form-label">Terminales de dirección</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalHidraulico" tabindex="-1" aria-labelledby="ModalHidraulicoLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_10" class="form-label">Estado y nivel aceite hidraulico</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_11" class="form-label">Bomba sistema hidraulico</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_12" class="form-label">Filtro de retorno</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_13" class="form-label">Bloque de valvulas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_14" class="form-label">Mangueras</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalMastil" tabindex="-1" aria-labelledby="ModalMastilLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_39" class="form-label">Ajuste mastil</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_40" class="form-label">Estado secciones</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_41" class="form-label">Bujes</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_42" class="form-label">Rodamientos</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_43" class="form-label">Cadenas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_44" class="form-label">Poleas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_45" class="form-label">Pasadores cadenas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_46" class="form-label">Mangueras free lift</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_47" class="form-label">Mangueras side shift</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_48" class="form-label">Mangueras fork positioner</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_49" class="form-label">Tuberías</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_50" class="form-label">Racores</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_51" class="form-label">Cilindros de inclinación</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_52" class="form-label">Cilindro de free lift</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_53" class="form-label">Cilindro laterales</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_54" class="form-label">Cilindro de side shift</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_55" class="form-label">Cilindro de fork positioner</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalCarroPorta" tabindex="-1" aria-labelledby="ModalCarroPortaLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #000020;">
                <h5 class="modal-title text-white" id="ModalCarroPortaLabel">Diagnóstico: Transmisión</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_36" class="form-label">Nivel de valvulina</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_37" class="form-label">Fugas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_38" class="form-label">Tornilleria</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <!-- ✅ Nuevo selector "No aplica" -->
                        <div class="form-check ms-2">
                            <input class="form-check-input" type="checkbox" id="noAplicaTransmision">
                            <label class="form-check-label" for="noAplicaTransmision">No aplica</label>
                        </div>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const noAplicaTransmision = document.getElementById('noAplicaTransmision');
        ...
        // ✅ Activar/desactivar por "No aplica"
        noAplicaTransmision.addEventListener('change', () => {
            const desactivar = noAplicaTransmision.checked;
        ...
        botonCarroPorta.addEventListener('click', () => {
            ...
            // ⚠️ Validar solo si no está marcado "No aplica"
            if (!noAplicaTransmision.checked && fileInputCarroPorta.files.length === 0) {
                alert('Debe subir al menos una imagen del diagnóstico o marcar "No aplica".');
                valido = false;
            }
            ...
            // ✅ Guardar valor NULL si "No aplica"
            if (noAplicaTransmision.checked) {
...
<div class="modal fade" id="ModalAditamientos" tabindex="-1" aria-labelledby="ModalAditamientosLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #000020;">
                <h5 class="modal-title text-white" id="ModalAditamientosLabel">Diagnóstico: Aditamentos</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_56" class="form-label">Side shift</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_57" class="form-label">Fork positioner</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_58" class="form-label">Boom</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalHorquillas" tabindex="-1" aria-labelledby="ModalHorquillasLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_59" class="form-label">Seguros</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_60" class="form-label">Mordaza superior</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_61" class="form-label">Mordaza inferior</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_62" class="form-label">Clase de horquillas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_63" class="form-label">Estado de horquillas (inspección visual ver F-208 como referencia)</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalRuedas" tabindex="-1" aria-labelledby="ModalRuedasLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_64" class="form-label">Estado y degaste de caucho de ruedas de carga</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_65" class="form-label">Estado y degaste de caucho de ruedas de dirección</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_66" class="form-label">Estado de rin de carga</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_67" class="form-label">Estado de rin de dirección</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalCaja" tabindex="-1" aria-labelledby="ModalCajaLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_94" class="form-label">Nivel de aceite</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_95" class="form-label">Filtro</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_96" class="form-label">Electroválvulas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_97" class="form-label">Mangueras de refrigeración</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_98" class="form-label">Convertidor de torque</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_99" class="form-label">Cardán</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label class="form-label">Subir Imágenes del Diagnóstico</label>
                    <div class="d-flex gap-2">
                        <button type="button" class="btn btn-outline-primary" id="btnTomarFotoCaja">Tomar Foto</button>
                        <button type="button" class="btn btn-outline-secondary" id="btnCargarImagenCaja">Cargar Imágenes</button>

                        <!-- ✅ Nuevo selector "No aplica" -->
                        <div class="form-check ms-2">
                            <input class="form-check-input" type="checkbox" id="noAplicaCaja">
                            <label class="form-check-label" for="noAplicaCaja">No aplica</label>
                        </div>
                    </div>
                </div>
                <button id="btnGuardarCaja" type="button" class="btn text-white" style="background-color: #000020;">Guardar Diagnóstico</button>
            </div>
        </div>
    </div>
</div>
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const selectsCaja = document.querySelectorAll('#ModalCaja select.form-select');
        const fileInputCaja = document.getElementById('imagenesDiagnosticoCaja');
        const botonCaja = document.getElementById('btnGuardarCaja');
        const btnTomarFotoCaja = document.getElementById('btnTomarFotoCaja');
        const btnCargarImagenCaja = document.getElementById('btnCargarImagenCaja');
        const noAplicaCaja = document.getElementById('noAplicaCaja');

        function actualizarEstadoCaja(selectCaja) {
            const iconCaja = document.getElementById(`icon-${selectCaja.id}`);
            selectCaja.classList.remove('select-Conforme', 'select-Nivelacion', 'select-Ajuste', 'select-Lubricacion', 'select-malo', 'select-vacio', 'select-Aplica');

            if (selectCaja.value === 'Conforme') {
                iconCaja.textContent = '✔️';
                iconCaja.style.color = 'green';
                selectCaja.classList.add('select-Conforme');
            } else if (selectCaja.value === 'Reparación') {
                iconCaja.textContent = '⚠️';
                iconCaja.style.color = 'red';
                selectCaja.classList.add('select-malo');
            }else if (selectCaja.value === 'Nivelacion') {
                iconCaja.textContent = '📏';
                iconCaja.style.color = 'yellow';
                selectCaja.classList.add('select-Nivelacion');
            }else if (selectCaja.value === 'Ajuste') {
                iconCaja.textContent = '⚙️';
                iconCaja.style.color = 'Orange';
                selectCaja.classList.add('select-Ajuste'); 
            }else if (selectCaja.value === 'Lubricación') {
                iconCaja.textContent = '🛢️';
                iconCaja.style.color = 'Blue';
                selectCaja.classList.add('select-Lubricacion');
            }else if (selectCaja.value === 'NoAplica') {
                iconCaja.textContent = '➖';
                iconCaja.style.color = 'Gray';
                selectCaja.classList.add('select-Aplica'); 
            }else {
                iconCaja.textContent = '❌';
                iconCaja.style.color = 'red';
                selectCaja.classList.add('select-vacio');
            }
        }

        selectsCaja.forEach(selectCaja => {
            selectCaja.addEventListener('change', () => actualizarEstadoCaja(selectCaja));
        });

        // Botón para tomar foto (cámara)
        btnTomarFotoCaja.addEventListener('click', () => {
            fileInputCaja.removeAttribute('multiple');
            fileInputCaja.setAttribute('capture', 'environment');
            fileInputCaja.click();
        });

        // Botón para cargar imágenes (galería/archivos)
        btnCargarImagenCaja.addEventListener('click', () => {
            fileInputCaja.setAttribute('multiple', 'true');
            fileInputCaja.removeAttribute('capture');
            fileInputCaja.click();
        });

        // ✅ Activar/desactivar por "No aplica"
        noAplicaCaja.addEventListener('change', () => {
            const desactivar = noAplicaCaja.checked;

            btnTomarFotoCaja.disabled = desactivar;
            btnCargarImagenCaja.disabled = desactivar;

            if (desactivar) {
                // Si marca "No aplica", limpia y marca como NULL
                fileInputCaja.value = "";
                fileInputCaja.setAttribute('data-null', 'true');
            } else {
                // Si desmarca, vuelve a habilitar
                fileInputCaja.removeAttribute('data-null');
            }
        });
        ...
        botonCaja.addEventListener('click', () => {
            ...
            selectsCaja.forEach(selectCaja => {
                if (!selectCaja.value) {
                    actualizarEstadoCaja(selectCaja);
                    valido = false;
                }
            });

            // ⚠️ Validar solo si no está marcado "No aplica"
            if (!noAplicaCaja.checked && fileInputCaja.files.length === 0) {
                alert('Debe subir al menos una imagen del diagnóstico o marcar "No aplica".');
                valido = false;
            }
            ...
            // ✅ También puedes mostrar los archivos seleccionados
            let archivos = [];
            for (let i = 0; i < fileInputCaja.files.length; i++) {
                archivos.push(fileInputCaja.files[i].name);
            }
            console.log("Imágenes cargadas:", archivos);

            // ✅ Guardar valor NULL si "No aplica"
            if (noAplicaCaja.checked) {
                fileInputCaja.value = ""; // sin archivos
                fileInputCaja.setAttribute('data-null', 'true');
            }

            // ✅ Cambiar color del card
            const card = document.getElementById('btnCajaCard').querySelector('div');
            card.classList.remove('bg-light');
            card.classList.add('bg-validado');

            // ❌ Cerrar modal actual
            const ModalCaja = bootstrap.Modal.getInstance(document.getElementById('ModalCaja'));
            ModalCaja.hide();
...
<div class="modal fade" id="ModalChasis" tabindex="-1" aria-labelledby="ModalChasisLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_100" class="form-label">Ajustes de conjunto</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_101" class="form-label">Chequear soportes</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_102" class="form-label">Tornilleria</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_103" class="form-label">Estado pintura</label>
                    <div class="d-flex align-items-center">
...
<div class="modal fade" id="ModalLuces" tabindex="-1" aria-labelledby="ModalLucesLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #000020;">
                <h5 class="modal-title text-white" id="ModalLucesLabel">Diagnóstico: Motor</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_15" class="form-label">Estado de cables de alta</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_16" class="form-label">Tapa de distribuidor</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_17" class="form-label">Rotor o escobilla</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_18" class="form-label">Módulo</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_19" class="form-label">Filtro de aceite</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_20" class="form-label">Varilla (baqueta o bayoneta)</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_21" class="form-label">Soportes de motor</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_22" class="form-label">Nivel de aceite de motor</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <!-- ✅ Nuevo selector "No aplica" -->
                        <div class="form-check ms-2">
                            <input class="form-check-input" type="checkbox" id="noAplicaMotor">
                            <label class="form-check-label" for="noAplicaMotor">No aplica</label>
                        </div>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const noAplicaMotor = document.getElementById('noAplicaMotor');
        ...
        // ✅ Activar/desactivar por "No aplica"
        noAplicaMotor.addEventListener('change', () => {
            const desactivar = noAplicaMotor.checked;
        ...
        botonLuces.addEventListener('click', () => {
            ...
            // ⚠️ Validar solo si no está marcado "No aplica"
            if (!noAplicaMotor.checked && fileInputLuces.files.length === 0) {
                alert('Debe subir al menos una imagen del diagnóstico o marcar "No aplica".');
                valido = false;
            }
...
<div class="modal fade" id="ModalLubricacion" tabindex="-1" aria-labelledby="ModalLubricacionLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_104" class="form-label">Engrase puente trasero</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_105" class="form-label">Engrase mastil</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_106" class="form-label">Lubricación cadenas y secciones mastil</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_107" class="form-label">Engrase de cardan</label>
                    <div class="d-flex align-items-center">
...
<!-- Modal Sistema de refigeración-->
<div class="modal fade" id="ModalCargador" tabindex="-1" aria-labelledby="ModalCargadorLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #000020;">
                <h5 class="modal-title text-white" id="ModalAditamientosLabel">Diagnóstico: Sistema de Refrigeración</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_23" class="form-label">Radiador</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_24" class="form-label">Correa de accesorios</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_25" class="form-label">Ventilador</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_26" class="form-label">Bomba de agua</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_27" class="form-label">Nivel de liquido refigerante</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_28" class="form-label">Manguera superior e inferior</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_29" class="form-label">Tapa de radiador de 13(psi)</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <!-- ✅ Nuevo selector "No aplica" -->
                        <div class="form-check ms-2">
                            <input class="form-check-input" type="checkbox" id="noAplicaRefigeracion">
                            <label class="form-check-label" for="noAplicaRefigeracion">No aplica</label>
                        </div>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const noAplicaRefigeracion = document.getElementById('noAplicaRefigeracion');
        ...
        // ✅ Activar/desactivar por "No aplica"
        noAplicaRefigeracion.addEventListener('change', () => {
            const desactivar = noAplicaRefigeracion.checked;
        ...
        botonCargador.addEventListener('click', () => {
            ...
            // ⚠️ Validar solo si no está marcado "No aplica"
            if (!noAplicaRefigeracion.checked && fileInputCargador.files.length === 0) {
                alert('Debe subir al menos una imagen del diagnóstico o marcar "No aplica".');
                valido = false;
            }
            ...
            // ✅ Guardar valor NULL si "No aplica"
            if (noAplicaRefigeracion.checked) {
...
<div class="modal fade" id="ModalRevision" tabindex="-1" aria-labelledby="ModalRevisionLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="Criterio_68" class="form-label">Limpieza del equipo</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_69" class="form-label">Horómetro</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_70" class="form-label">Etiquetas de seguridad</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_71" class="form-label">Limpieza área de trabajo</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_72" class="form-label">Manual de operaciones</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_73" class="form-label">Tapas</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_74" class="form-label">Capó y amortiguador</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_75" class="form-label">Silla</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_76" class="form-label">Cinturon de seguridad</label>
                    <div class="d-flex align-items-center">
                ...
                <div class="mb-3">
                    <label for="Criterio_77" class="form-label">Extintor</label>
                    <div class="d-flex align-items-center">
