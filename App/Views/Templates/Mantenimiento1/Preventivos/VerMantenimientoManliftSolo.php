...
<body>
    ...
    <table border="1">
        <thead>
            <tr>
                ...
                <th rowspan="3" class="Titulo" style="font-size: 14px;" >REPORTE DE MANTENIMIENTO PREVENTIVO MANLIFT</th>
                <th>CODIGO:</th>
                <td>F-211-4</td>
            </tr>
            <tr>
    ...
    <table border="1">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">No. de bateria</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Compartimiento batería</td>
            ...
            <tr>
                <td colspan="2" style="font-weight: bold;">Estado de la batería</td>
